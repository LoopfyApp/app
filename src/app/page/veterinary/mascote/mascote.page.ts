...
export class MascotePage implements OnInit {
  ...
  constructor(
    ...
    this.url = `home/veterinary/listshop/${this.id_especie}/${this.categorie}`;
  }
  ...
  getSelectMascote(data){
    let urls = `home/veterinary/listservices/${this.id_especie}/${this.categorie}/${this.store}/${data.id}`;
