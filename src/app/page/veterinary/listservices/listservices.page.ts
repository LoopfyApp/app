...
export class ListservicesPage implements OnInit {
  ...
  constructor(public utils:UtilsService,
    ...
    public server:ServerService) {
      ...
      this.url=`home/veterinary/mascote/${ this.dataList.id_especie}/${this.dataList.categorie}/${this.dataList.store_id}`;
  ...
  async listService(){
    this.server.GetLojasServicesVeterinaryList(this.dataList).then((data:any)=>{
  ...
  selectService(data){
    let url
    url=`home/veterinary/calendarservices/${ this.dataList.id_especie}/${this.dataList.categorie}/${this.dataList.store_id}/${this.pets}/${data.id}`;
