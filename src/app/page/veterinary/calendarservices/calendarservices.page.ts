...
export class CalendarservicesPage implements OnInit {
  ...
  constructor(public utils:UtilsService,
    ...
    public server:ServerService) {
      ...
      this.url=`home/veterinary/listservices/${ this.dataList.id_especie}/${this.dataList.categorie}/${this.dataList.store_id}/${this.dataList.pets}`;
...
save(){
  ...
  this.server.InsertItemCartService(this.SaveCarts).then((data:any)=>{
    ...
    this.router.navigateBack('/home/confirmationcart/1');

  }).catch((error:any)=>{

    this.utils.dismissLoading();
    this.utils.showToast('Ocorreu um erro ao salvar os dados, tente novamente');
  })
}
